//Client para sincronización de relojes mediante el algoritmo de Cristian, usando directamente la interfaz de sockets.
...
void sincronizar(int s)
{
	...
	printf("El valor de D obtenidjava program for Cristian's algorithm githubo en este intento,\n");
